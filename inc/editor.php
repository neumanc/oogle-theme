...
function oogle_allowed_blocks( $allowed, WP_Block_Editor_Context $context ) {
	...
	$blocks = array(
		...
		'core/code', 'core/table', 'core/details', 'core/accordion', 'core/accordion-item',
		'core/accordion-heading', 'core/accordion-panel', 'core/tabs', 'core/tab-list', 'core/tab-panels', 'core/tab-panel',
		// Media.
		'core/image', 'core/gallery', 'core/cover', 'core/media-text', 'core/video', 'core/audio', 'core/file', 'core/embed', 'core/icon',
		// Design.
		'core/group', 'core/columns', 'core/column', 'core/buttons', 'core/button', 'core/separator', 'core/spacer',
		// Theme / dynamic.
		'core/pattern', 'core/block', 'core/shortcode', 'core/html', 'core/breadcrumbs', 'core/social-links', 'core/social-link',
		'core/query', 'core/post-template', 'core/query-pagination', 'core/query-pagination-next', 'core/query-pagination-previous',
		'core/query-pagination-numbers', 'core/query-no-results', 'core/post-title', 'core/post-excerpt', 'core/post-featured-image',
		'core/post-date', 'core/post-terms', 'core/read-more', 'core/latest-posts', 'core/search', 'core/site-logo', 'core/site-title',
		'core/site-tagline', 'core/navigation', 'core/navigation-link', 'core/navigation-submenu', 'core/page-list',
		'core/terms-query', 'core/term-template', 'core/term-name', 'core/term-description', 'core/term-count',
	);
